    ...
    <>
      ...
      <aside
        className={`
          ...
          bg-gradient-to-b from-[#0A3D2A] to-[#064E3B]
      ...
      >
        ...
        <div className="flex items-center gap-3 h-16 px-5 border-b border-white/10">
          ...
          <Link href="/dashboard" className="min-w-0">
            ...
            <p className="text-[11px] text-emerald-300/80">মুমিনপুর মাদরাসা</p>
          </Link>
        </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                `}
              >
                <span className={isActive ? "text-emerald-300" : "text-emerald-300/50"}>
                  {item.icon}
                </span>
                {item.label}
              </Link>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-white/10">
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-emerald-100/60 hover:bg-white/10 hover:text-white transition-all duration-150"
          >
